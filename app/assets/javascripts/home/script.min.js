 ...
 ! function(e) {
     ...
     function m(e, a) {
         var t = document.getElementById("map-zoom-in"),
             o = document.getElementById("map-zoom-out");
         e.appendChild(t), e.appendChild(o), google.maps.event.addDomListener(t, "click", function() {
     ...
     function h() {
         if (e("#map-section").length) {
             var a = e("#map-opener"),
                 t = e("#map-section");
             a.on("click", function() {
                 t.toggleClass("map-opened")
             });
             var o = 14,
                 i = "#111518",
                 n = "<div class='gmap-popup'><h4>Our primary office</h4><p>Your notes sits here!</p></div>",
                 s = navigator.userAgent.toLowerCase().indexOf("trident") > -1,
                 l = s ? "img/google-map-assets/map-icon-location.png" : "img/google-map-assets/map-icon-location.svg",
                 r = [{
                 ...
                 p = e("#map-canvas").attr("data-address");
             d.geocode({
                 address: p
             }, function(e, a) {
                 if (a == google.maps.GeocoderStatus.OK) {
                     ...
                     i.controls[google.maps.ControlPosition.LEFT_TOP].push(p)
     ...
     if (isMobile || screen.width < 768) o(), i(), n(), s(), l(), r(), p(), a(), t(), c(), C.hasClass("animsition") || f(), d(), u(), g(), h();
     else {
         var A, B, F, G, U, Q = new WOW({
             ...
             ra = e("#team-section").find(".team-item"),
             da = function() {
                 ra.mouseenter(function() {
                     e(this).find(".skillbar-bar").each(function() {
                         var a = e(this);
                         a.width(a.attr("data-percent"))
                     })
                 }).mouseleave(function() {
                     ra.find(".skillbar-bar").width(0)
                 })
             },
             pa = e("#go-top"),
             ca = function() {
         ...
         if (V.each(function() {
             ...
             }), ta(), N(), ca(), t(), o(), i(), n(), ua(), Q.init(), na(), da(), la(), s(), l(), r(), p(), a(), c(), d(), ea(), u(), ia(), g(), C.hasClass("animsition") || (f(), v()), !isMobile) {
             var fa;
             y.resize(function() {
                 ua(), clearTimeout(fa), fa = setTimeout(function() {
                     skrollr.init({
                         forceHeight: !1,
                         smoothScrolling: !1
                     }).refresh();
